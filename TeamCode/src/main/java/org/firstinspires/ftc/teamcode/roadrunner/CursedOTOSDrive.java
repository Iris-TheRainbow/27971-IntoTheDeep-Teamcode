 ...
 */
public class CursedOTOSDrive extends CursedMecanumDrive {
    ...
    public static CursedOTOSDrive.Params PARAMS = new CursedOTOSDrive.Params();
    public SparkFunOTOSCorrected otos;
    private Pose2d lastOtosPose = pose;

    private final DownsampledWriter estimatedPoseWriter = new DownsampledWriter("ESTIMATED_POSE", 50_000_000);

    public CursedOTOSDrive(HardwareMap hardwareMap, Pose2d pose) {
